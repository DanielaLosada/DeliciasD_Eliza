...
//            socketComunicacion.close();
    ...
    private void enviarObjeto() throws IOException {
        ...
        iniciarSalvarDatosPrueba();
 //= Persistencia.cargarRecursoBancoBinario();
        flujoSalidaObjeto.writeObject((Object)red);
        System.out.println("Se envi� la red");
        //inicializarDatos();
	}	
    public Red getRed() {
		return red;
    ...
    private void inicializarDatos() {
		...
		listaVendedores.add(vendedor5);
		 ...
		 administrador.setDocumento("10923870251");
		 administrador.setContrasenia("DAX");
		 
		 red.setListaVendedores(listaVendedores);
